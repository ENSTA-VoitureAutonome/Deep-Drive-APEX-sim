...
echo "  ./simulation/tools/sim/apex_general_map_publisher_up.sh ${FIXED_MAP_DIR}/fixed_map.yaml ${FIXED_MAP_DIR}/mapping_summary.json"
echo "  rviz2 -d ${APEX_SIM_ROOT}/rviz/apex_manual_mapping_offline.rviz"
echo "[APEX] Fixed-map run command:"
echo "  ./simulation/tools/sim/apex_sim_up.sh --scenario baseline --rviz --fixed-map-run ${RUN_DIR}"

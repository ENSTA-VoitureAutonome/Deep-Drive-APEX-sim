...
REMOTE_STATUS_PATH="${APEX_REMOTE_STATUS_PATH:-/home/ensta/AiAtonomousRc/real_vehicle/.apex_runtime/real_session/status.json}"
REMOTE_RUN_ROOT="${APEX_REMOTE_RECOGNITION_ROOT:-/home/ensta/AiAtonomousRc/real_vehicle/ros2_ws/apex_recognition_tour}"
